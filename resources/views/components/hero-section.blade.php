...
<p
    id="jks-hero-text"
    class="manrope-400 text-white text-base md:text-xl font-thin max-w-6xl mx-auto px-8 md:px-15 lg:px-28 xl:px-32 !leading-[34px] tracking-wide opacity-0 text-justify"
