<!-- <section class="flex h-[480px] bg-white overflow-hidden">
    <div class="flex-none w-[20%] h-full p-6 md:p-10">
        <img src="/images/leadership-image.png" alt="Leadership Team" class="w-full h-full object-cover rounded-none border-none shadow-none" />
    </div>
    <div class="flex-grow h-full flex flex-col justify-center px-6 py-10 md:py-12">
        <h2 class="text-2xl font-serif font-semibold text-gray-800 mb-6 leading-snug">
            Leadership<br>Team
        </h2>
