<section class="w-full flex flex-col md:flex-row min-h-[480px] bg-white overflow-hidden">
    ...
    <div class="flex-grow flex items-center relative bg-white  scroll-view">
        ...
        <div class="relative z-10 md:w-[80%] xl:w-[440px] w-full mx-auto p-10 sm:p-10 md:p-0 lg:p-10 xl:p-0 2xl:p-0">
            <h2 class="text-2xl xl:text-[30px] font-serif font-normal text-[#473c38] mb-8 leading-tight scroll-view">
                Leadership<br>Team
            </h2>
            <p class="text-md xl:text-[16px] text-justify text-[#473c38] leading-relaxed mb-0 xl:mb-8 font-serif scroll-view">
Our team comprises of investment professionals, legal, financial experts, and trusted advisors dedicated to executing the family’s strategic direction. Seasoned executives ensure alignment with long-term goals while maintaining a clear and  agile governance structure.            </p>
        </div>
    </div>
</section>
