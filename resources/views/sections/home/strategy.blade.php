<section class="w-full flex flex-col xl:flex-row md:flex-row min-h-[480px] bg-white overflow-hidden">
    <!-- Left image: 33% width -->
    <div class="flex-none md:w-[52%] w-full h-auto md:h-auto p-0 md:p-0 scroll-view">
    ...
    <div class="flex-grow flex items-center relative bg-white px-7 md:px-20 py-10 md:py-12 scroll-view">
        <img src="/images/white-texture.jpg" alt="" class="order-1 xl:order-1 absolute inset-0 w-full h-full object-cover opacity-100 pointer-events-none" />
        <div class="relative z-10 max-w-xl md:w-[480px] w-full mx-auto ">
            <h2 class="text-2xl xl:text-5xl font-serif font-normal text-[#473c38] mb-8 leading-tight scroll-view">
                Strategy
            </h2>
            <p class="text-md xl:text-xl text-justify text-[#473c38] leading-relaxed font-serif mb-0 xl:mb-8 scroll-view">
