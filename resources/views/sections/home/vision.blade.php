        ...
        <div class="order-2 xl:order-1 w-full flex flex-col justify-center  scroll-view">
            <div class="relative z-10 max-w-xl md:w-[480px] w-full mx-auto p-10 xl:y-0">
                ...
                <p class="text-md xl:text-[16px] text-justify text-[#473c38] leading-relaxed font-serif mb-0 xl:mb-8">
                    Our vision is to sustain and grow the family wealth across generations, guided by strong leadership, strategic investment, and enduring values. We are committed to responsible stewardship-where tradition meets innovation to create lasting value, support entrepreneurial ventures, and preserve a meaningful legacy for the future.
                </p>
            </div>
        </div>
