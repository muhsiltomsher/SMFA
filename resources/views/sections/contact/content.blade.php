    ...
    <div class="flex-grow flex items-center relative bg-white px-7 md:px-10 py-10 md:py-20 scroll-view">
        <div class="relative z-10 max-w-xl w-full mx-auto">
            ...
            <div class="mb-4 text-[#544541] scroll-view">
                ...
                <p class="mb-3 font-serif font-normal">
                   PO Box 926100
            ...
            <div class="mb-4 text-[#544541] scroll-view">
                <p class="font-bold mb-2 text-md xl:text-[16px]">EMAIL</p>
                <a href="mailto:info@thepvoffice.com" class=" underline scroll-view">info@thepvoffice.com</a>
            </div>
        </div>
    </div>
</section>
